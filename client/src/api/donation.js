...
export const updateDonationStatus = (id, status) =>
  instance.patch(`/donation/${id}`, status)
...
export const verifyOTP = (phoneNumber, otp) =>
  instance.post('/verify-otp', { phoneNumber, otp })
export const getEventDonation = (event_id) =>
  instance.get(`/donation/event/${event_id}`)
...
export const getDonationHistory = (id) =>
  instance.get(`/donation/history/${id}`)
